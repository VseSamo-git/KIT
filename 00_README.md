# KIT — Декор и флористика, Санкт-Петербург

Репозиторий проекта по перезапуску бренда и фабрики контента KIT.
...
- [ ] `06_pipeline/skills.md` — кастомные KIT-скиллы (для Claude Code)
...
- [ ] Первый пост «Мы обновились — встречайте KIT»
